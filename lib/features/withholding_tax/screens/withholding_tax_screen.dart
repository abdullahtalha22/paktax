...
class _WithholdingTaxScreenState extends State<WithholdingTaxScreen> {
  ...
  void _calculate() {
    ...
    setState(() {
      _taxAmount = amount * rate;
      _netAmount = amount - _taxAmount;
      _hasResult = true;
    });
  }
                    ...
                    if (_hasResult) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: AppColors.whtOrange.withOpacity(0.25)),
                        ),
                        child: Row(
                          children: [
                            Icon(Icons.info_outline_rounded,
                                color: AppColors.whtOrange, size: 16),
                            const SizedBox(width: 10),
                            Text(
                              'Rate: ${((_rates[_selectedType] ?? 0) * 100).toStringAsFixed(1)}% on gross payment',
                              style: GoogleFonts.sora(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: InfoCard(
                              label: 'WHT Deducted',
                              value: 'Rs ${_taxAmount.toStringAsFixed(0)}',
                          ...
                          Expanded(
                            child: InfoCard(
                              label: 'Net Payment',
                              value: 'Rs ${_netAmount.toStringAsFixed(0)}',
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.whtOrange.withOpacity(0.10),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Text(
